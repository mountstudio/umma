            ...
            <div class="col-12 col-lg-5  text-center pb-4">
                ...
                <form method="POST" action="{{ route('register') }}">
                    <div class="form-group">
                        <input type="text" class="form-control rounded-pill small form-control-sm"
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control rounded-pill small form-control-sm" placeholder="Телефон"
                               id="exampleInputPassword1">
                    </div>
                    <div class="form-group">
                        <input type="password" class="form-control rounded-pill small form-control-sm"
                               placeholder="Введите пароль" id="exampleInputPassword1">
                    </div>
                    <div class="form-group">
                        <input type="password" class="form-control rounded-pill small form-control-sm"
                               placeholder="Повторите пароль" id="exampleInputPassword1">
                    </div>
                    <button type="submit" class="btn btn-success btn-sm rounded-pill ">Создать аккаунт</button>
                    <button type="submit" class="btn btn-danger btn-sm rounded-pill ">Войти</button>
                </form>
                {{--                <div class="card">--}}
