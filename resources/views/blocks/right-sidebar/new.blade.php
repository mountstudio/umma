        ...
        <ul class="content-list content-list_most-read">
            @foreach($articles_for_subblock as $key=>$article)
                <li class="content-list__item content-list__item_devided post-info">
                    <a href="{{ route('show.article', $article) }}" class="text-decoration-none post-info__title">{{ $article->name }}</a>
                    <div class="post-info__meta">
                        ...
                        <a class="post-info__meta-item text-decoration-none" href="{{ route('show.article', $article) }}">
