<div class="col-12 border border-3 rounded  p-3">
    <ul class="nav nav-pills d-flex justify-content-center  mb-3" id="pills-tab" role="tablist">
        <li class="nav-item">
            <a class="nav-link p-2 small namaz-tabs active" id="pills-bishkek-tab" data-toggle="pill" href="#pills-bishkek" role="tab"
               aria-controls="pills-bishkek" aria-selected="true">Бишкек/Чуй</a>
        </li>
        <li class="nav-item">
            <a class="nav-link p-2 small namaz-tabs" id="pills-ik-tab" data-toggle="pill" href="#pills-ik" role="tab"
               aria-controls="pills-ik" aria-selected="false">ИК</a>
        </li>
        <li class="nav-item">
            <a class="nav-link p-2 small namaz-tabs" id="pills-talas-tab" data-toggle="pill" href="#pills-talas" role="tab"
               aria-controls="pills-talas" aria-selected="false">Талас</a>
        </li>
        <li class="nav-item">
            <a class="nav-link p-2 small namaz-tabs" id="pills-narin-tab" data-toggle="pill" href="#pills-narin" role="tab"
               aria-controls="pills-narin" aria-selected="false">Нарын</a>
        </li>
        <li class="nav-item">
            <a class="nav-link p-2 small namaz-tabs" id="pills-ja-tab" data-toggle="pill" href="#pills-ja" role="tab"
               aria-controls="pills-ja" aria-selected="false">Ж-А</a>
        </li>
        <li class="nav-item">
            <a class="nav-link p-2 small namaz-tabs" id="pills-osh-tab" data-toggle="pill" href="#pills-osh" role="tab"
               aria-controls="pills-osh" aria-selected="false">Ош</a>
        </li>
        <li class="nav-item">
            <a class="nav-link p-2 small namaz-tabs" id="pills-batken-tab" data-toggle="pill" href="#pills-batken" role="tab"
