                ...
                <div class="card-body text-center">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12">
                            ...
                            <p class="card-text text-uppercase" style="min-height: 52px;">Украденное слово "Аллаху Акбар"</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body text-center">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12">
                            ...
                            <p class="card-text text-uppercase" style="min-height: 52px;">Праведный халиф Умар Ибн Хаттаб</p>
                        </div>
                    </div>
                </div>
            </div>
