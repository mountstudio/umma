...
{{--    <hr style="background-color: black;color: black;">--}}
    <div class="row justify-content-around">
        ...
        <div class="col-12 col-lg-4 col-md-12">
            ...
            @if($hadith)
                <div class="border border-4 border-orange rounded px-3 pt-3 pb-1">
                    <p style="display: -webkit-box;-webkit-line-clamp: 8;-webkit-box-orient: vertical;overflow: hidden;text-overflow: ellipsis;">{!! $hadith->content !!}</p>
