        ...
        <div class="col-12 col-sm-10 col-lg-10 col-md-10">
            <form action="{{ route('admin.multimedia.update', $multimedia) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input  id="title_field" value="{{ $multimedia->title }}" type="text" class="form-control" name="title" required>
                </div>
                <div class="form-group">
                    <label for="video_input">Ссылка на видео</label>
                    <input id="video_input"value="{{ $multimedia->url_video }}" type="text" class="form-control" name="url_video" required>
                </div>
                <div class="form-group">
