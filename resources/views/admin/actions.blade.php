<div class="row justify-content-center">
    <form id="form-{{ $model->id }}" name="delete-form" method="POST" action="{{ route('admin.'.$type.'.destroy', $model) }}">
        @csrf
        @method('DELETE')
        <button type="button" onclick="deleteConfirm(this)" data-id="{{ $model->id }}" title="{{ __('Удалить') }}" class="btn n btn-danger">
