<div class="list-group">
    ...
    <a href="{{ route('admin.question.datatable') }}" class="list-group-item list-group-item-action {{ request()->is('admin/question*') && !request()->is('*Categor*') ? 'active' : '' }}">{{ __('Вопросы') }}</a>
    ...
    <a href="{{ route('admin.poster.datatable') }}" class="list-group-item list-group-item-action {{ request()->is('admin/poster*') && !request()->is('*Type*') ? 'active' : '' }}">{{ __('Афиша') }}</a>
